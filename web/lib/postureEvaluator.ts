// Espejo en cliente de api/src/modules/biomechanics/healthyZones.ts y la
// lógica de api/src/modules/errors/errors.detect.ts — mismos umbrales, para
// que el color mostrado en el esqueleto coincida con lo que reporta la
// pantalla de Errores. Corre en cliente porque el overlay se dibuja en vivo
// cuadro a cuadro sobre el <canvas>, sin ida y vuelta al servidor por frame.
